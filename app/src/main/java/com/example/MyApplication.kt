...
class MyApplication : Application() {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            database
            android.util.Log.d("MyApplication", "Database initialized")
        } catch (e: Throwable) {
        ...
        try {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                SupabaseSyncManager.syncBreakoutsWithCloud()
            }
            ...
            android.util.Log.d("MyApplication", "Workers and MarketEngine started")
        } catch (e: Throwable) {
        ...
        if (!prefs.getBoolean("fresh_trade_reset_v25", false)) {
            CoroutineScope(Dispatchers.IO).launch {
                ...
                prefs.edit().putBoolean("fresh_trade_reset_v25", true).apply()
            }
        }
